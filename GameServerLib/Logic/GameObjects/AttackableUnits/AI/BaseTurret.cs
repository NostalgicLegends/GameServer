...
namespace LeagueSandbox.GameServer.Logic.GameObjects
{
    public class BaseTurret : ObjAIBase
    {
        ...
        public override void UpdateReplication()
        {
            ...
            ReplicationManager.UpdateFloat(Stats.PercentAttackSpeedMod, 1, 11);
            ...
            ReplicationManager.UpdateFloat(Stats.FlatSightRangeMod, 3, 2);
            ReplicationManager.UpdateFloat(Stats.PercentSightRangeMod, 3, 3);
        ...
        public void CheckForTargets()
        {
            ...
            foreach (var it in objects)
            {
                ...
                if (u == null || u.IsDead || u.Team == Team || GetDistanceTo(u) > Stats.TotalAttackRange)
                {
                    continue;
                }
