...
namespace LeagueSandbox.GameServer.Logic.GameObjects
{
    ...
    public class Minion : ObjAIBase
    {
        ...
        public override void UpdateReplication()
        {
            ...
            ReplicationManager.UpdateFloat(Stats.PercentAttackSpeedMod, 1, 15);
            ...
            ReplicationManager.UpdateFloat(Stats.PercentMagicReduction, 1, 22);
            ReplicationManager.UpdateFloat(Stats.FlatSightRangeMod, 3, 0);
            ReplicationManager.UpdateFloat(Stats.PercentSightRangeMod, 3, 1);
